...
TapLink Negócios é um software proprietário criado por Nicholas Richardson e desenvolvido para exploração pela GigaNetPe Telecom.

Todos os direitos são reservados. Este repositório não é open source. Acesso não significa autorização de uso.
